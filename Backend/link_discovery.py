...
def _is_valid_url(url: str) -> bool:
    ...
    # Reject pseudo-links
    if not url or url.startswith(('javascript:', 'mailto:', 'tel:', 'sms:', 'whatsapp:')):
        return False
...
def get_links_from_html(
    ...
    try:
        ...
        print(f"LinkDiscovery: Found {len(unique_links)} unique links after deduplication")
        print(f"LinkDiscovery: Starting filtering (include_external={include_external})...")
