...
export default function Pricing({ onBack }) {
	...
	const totalMessages = userStats.reduce(
		(sum, user) => sum + (user.total_messages || 0),
		0
	);
	const totalCost = userStats.reduce(
		(sum, user) => sum + (user.cost_usd || 0),
		0
	);
		...
		<div className="min-h-screen bg-gradient-to-b from-white to-zinc-50 flex flex-col animate-fade-in">
			...
			<main className="flex-1 mx-auto max-w-6xl px-4 py-8">
				...
				<div className="mb-6 sm:mb-8 animate-fade-in">
					...
					<p
						className="text-sm sm:text-base text-gray-600 max-w-2xl animate-slide-up"
				...
				{!loading && !error && (
					<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8">
						<div
							className="rounded-2xl border border-gray-200 bg-white/80 backdrop-blur shadow-sm p-5 hover:shadow-lg hover:scale-105 hover:border-indigo-300 transition-all duration-300 animate-slide-up"
						...
						<div
							className="rounded-2xl border border-gray-200 bg-white/80 backdrop-blur shadow-sm p-5 hover:shadow-lg hover:scale-105 hover:border-purple-300 transition-all duration-300 animate-slide-up"
						...
						<div
							className="rounded-2xl border border-gray-200 bg-white/80 backdrop-blur shadow-sm p-5 hover:shadow-lg hover:scale-105 hover:border-green-300 transition-all duration-300 animate-slide-up"
