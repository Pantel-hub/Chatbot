		...
		<div className="min-h-screen bg-gradient-to-b from-white to-zinc-50 flex flex-col animate-fade-in">
			...
			<main className="mx-auto max-w-6xl px-4 py-8 flex-1">
				...
				<div className="mb-8 sm:mb-12 text-center animate-fade-in">
					...
					<p
						className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto animate-slide-up"
				...
				<div className="max-w-4xl mx-auto">
					<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
						<div
							className="rounded-2xl border border-gray-200 bg-white/80 backdrop-blur shadow-sm p-6 hover:shadow-lg hover:scale-105 hover:border-indigo-300 transition-all duration-300 animate-slide-up"
						...
						<div
							className="rounded-2xl border border-gray-200 bg-white/80 backdrop-blur shadow-sm p-6 hover:shadow-lg hover:scale-105 hover:border-purple-300 transition-all duration-300 animate-slide-up"
						...
						<div
							className="rounded-2xl border border-gray-200 bg-white/80 backdrop-blur shadow-sm p-6 hover:shadow-lg hover:scale-105 hover:border-green-300 transition-all duration-300 animate-slide-up"
						...
						>
							...
							<p className="text-gray-600 text-sm">
								Ανδρέα Παπανδρέου 47
							</p>
							<p className="text-gray-600 text-sm">
								15232 Χαλάνδρι Αττική Ελλάδα
							</p>
						</div>
					</div>
				</div>
