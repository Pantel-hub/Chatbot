...
export default function LoadingPage({
	...
	progress = null,
	tips = [
		"Μην κλείσεις αυτή τη σελίδα",
		"Μπορεί να διαρκέσει μερικά δευτερόλεπτα",
	],
	onCancel = null,
}) {
	return (
		<div className="flex flex-col items-center justify-center h-full gap-10 bg-gray-50 text-gray-800">
			...
			<div className="text-center">
				<p className="text-lg font-medium tracking-wide text-gray-700">
					...
					<span className="inline-flex w-10 overflow-hidden align-bottom">
						...
						<span className="animate-[blink_1.4s_ease-in-out_infinite_0.2s]">
							.
						</span>
						<span className="animate-[blink_1.4s_ease-in-out_infinite_0.4s]">
							.
						</span>
					</span>
				</p>
			...
			<div className="w-full max-w-sm">
				...
				<div className="mt-4 grid grid-cols-3 gap-3">
					<div
						className="h-4 rounded bg-gray-200/80 animate-pulse"
