...
const UploadFiles = forwardRef(
	(
		...
		const ALLOWED_EXTENSIONS_DISPLAY =
			"TXT, PDF, DOCX, MD, HTML, PPTX, JSON, JS, PY, CPP, JAVA, CSS, PHP, GO, TS, RB, SH, TEX";
		...
		const baseInputClasses =
			"w-full p-3 pl-10 border rounded-lg transition duration-200 bg-slate-50 focus:bg-white focus:outline-none";
		const normalClasses =
			...
			<div className="space-y-8">
				...
				<div>
					...
					<label
						...
						className="flex flex-col items-center justify-center w-full h-32 border-2 border-slate-300 border-dashed rounded-lg cursor-pointer bg-slate-50 hover:bg-slate-100 transition"
					>
