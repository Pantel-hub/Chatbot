		...
		<div className="w-full px-4 sm:px-6 py-4 bg-white border-t border-gray-200">
			<div className="flex items-start">
				{steps.map((step, index) => {
					...
					// --- Classes for styling ---
					let circleClass =
						"w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm transition-all duration-300 relative z-10";
					let lineClass = "flex-1 h-0.5 transition-all duration-300";
					let textClass =
						"text-xs mt-2 text-center transition-all duration-300 w-20";
