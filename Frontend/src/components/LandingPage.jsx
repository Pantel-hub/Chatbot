...
export default function LandingPage({
	...
	// Use chatbot logo instead of landing SVG
							...
							<div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center w-full">
								<div className="max-w-3xl">
									...
									<div className="mt-6 sm:mt-10 grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
										<div
											className="rounded-2xl border border-gray-200 bg-white p-5 flex items-start gap-3 hover:shadow-lg hover:scale-105 hover:border-indigo-300 transition-all duration-300 animate-slide-up"
										...
										>
											...
											<div>
												<h3 className="font-semibold">
													{t(
														"landing.features.cleanDesign.title",
														"Clean Design"
													)}
												</h3>
												<p className="mt-1 text-sm text-gray-600">
													{t(
														"landing.features.cleanDesign.desc",
														"Modern typography and balanced layout."
													)}
												</p>
											</div>
										</div>
										...
										>
											...
											<div>
												<h3 className="font-semibold">
													{t(
														"landing.features.secureFast.title",
														"Secure & Fast"
													)}
												</h3>
												<p className="mt-1 text-sm text-gray-600">
													{t(
														"landing.features.secureFast.desc",
														"Best practices and lightweight assets."
													)}
												</p>
											</div>
										</div>
										...
										>
											...
											<div>
												<h3 className="font-semibold">
													{t(
														"landing.features.easyLaunch.title",
														"Easy to Launch"
													)}
												</h3>
												<p className="mt-1 text-sm text-gray-600">
													{t(
														"landing.features.easyLaunch.desc",
														"Copy, paste, customize in seconds."
													)}
												</p>
											</div>
										</div>
